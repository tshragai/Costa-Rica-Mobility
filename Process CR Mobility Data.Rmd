...
file_info <- drive_find(pattern = "all_processed_combined.csv", path = target_folder)
if (nrow(file_info) > 0) {
  ...
  stop("File 'all_processed_combined.csv' not found in Google Drive folder")
}
...
file_info <- drive_find(pattern = "activity_by_pop_tiles_overall_wgs84.geojson", path = target_folder)
if (nrow(file_info) > 0) {
  ...
  stop("File 'activity_by_pop_tiles_overall_wgs84.geojson' not found in Google Drive folder")
}  
