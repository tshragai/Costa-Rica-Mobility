...
- **Used in**: Combine CR malaria and mobility data.Rmd, Process CR malaria data.Rmd
...
- **Used in**: Combine CR malaria and mobility data.Rmd
...
- **Created by**: Combine CR malaria and mobility data.Rmd
- **Used in**: Combine CR malaria and mobility data.Rmd, Create static malaria mobility figures.Rmd
...
- **Created by**: Combine CR malaria and mobility data.Rmd
- **Used in**: Combine CR malaria and mobility data.Rmd, Create static malaria mobility figures.Rmd, Shiny app
...
4. **All Above** → Combine CR malaria and mobility data.Rmd → `malaria_cases_2023_points.rds`, `districts_polygons_minimal.rds`, `mobility_flows_with_elevation.rds`, `shiny_mobility_data.rds`
