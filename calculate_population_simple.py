#!/usr/bin/env python3
"""
Calculate population for the uploaded GeoJSON tiles with simple asset path.
"""
...
def main():
    ...
    print("=== Population Calculation (Simple Asset Path) ===")
    
    # Initialize GEE
    ee.Initialize()
    print("✓ Google Earth Engine initialized successfully")
    
    # Asset ID of the uploaded GeoJSON tiles (simple path)
    ...
    try:
        ...
        export_task = ee.batch.Export.table.toDrive(
            ...
            description='costa_rica_tile_population_2020_simple',
            fileFormat='CSV'
        )
        ...
        print("Upload Task ID: 4V4TLOMRUYVPUTLBNKG5AFS6")
