#!/usr/bin/env python3
"""
Calculate population for both WorldPop and GHSL datasets and combine into one file.
"""
...
def main():
    ...
    try:
        ...
        pop2020_ghsl = (
            ee.ImageCollection('JRC/GHSL/P2023A/POP')
            .filterDate('2020-01-01', '2020-12-31')
            .select('population')
            .mosaic()
        )
        ...
        print(f"❌ Error: {e}")
        print("\nTrying alternative GHSL collection...")
        
        # Try alternative GHSL approach
        try:
            print("Trying alternative GHSL collection...")
            
            # Try different GHSL collection
            pop2020_ghsl_alt = (
            ...
            print("✓ Alternative GHSL collection loaded")
            
            # Continue with the same calculation process...
            # (You can uncomment and modify the rest if needed)
            
        except Exception as e2:
            print(f"❌ Alternative approach also failed: {e2}")
            print("Let's check what GHSL collections are available...")
